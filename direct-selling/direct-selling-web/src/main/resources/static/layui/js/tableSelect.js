layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    tableSelect.prototype.render = function (opt) {
        ...
        if(opt.selectBtn != undefined){
            selectBtn = opt.selectBtn;
        }
        ...
        elem.off('click').on('click', function(e) {
            ...
            tableBox += '</form>';
            tableBox += (selectBtn?'<button style="float:right;" class="layui-btn layui-btn-sm tableSelect_btn_select">选择<span></span></button>':'')
            tableBox += '</div>';
            ...
            table.on('row('+tableName+')', function(obj){
                if(obj.tr.find("input[type='radio']").length>0) {
