...
@RestController
@RequestMapping("/api/after/sale/coupon")
public class AfterSaleCouponApiController {
            ...
            if (CollectionUtils.isNotEmpty(saleOrderRecordList)){
                for (AfterSaleOrderRecord v : saleOrderRecordList) {
                    ...
                    if (v.getOrderType().equals(AfterSaleConstants.OrderType.PROMOTION_CARD.getCode())
                        ...
                        dto.setCouponStatus(AfterSaleConstants.CouponStatus.INVALID.getCode());
                    } else {
                        dto.setCouponStatus(AfterSaleConstants.CouponStatus.USE_NON.getCode());
                    }
