...
public class RandomValidateCodeService {
     ...
     * 生成随机图片
     */
    public void getRandcode(HttpServletRequest request, HttpServletResponse response, String userPhone) {
        ...
        try {
            //将随机生成的验证码放入redis
            redisService.set(DirectCommonUtil.FISSION_SALE_LOGIN_VERIFY_CODE+ userPhone, randomString, 3*60*1000);
