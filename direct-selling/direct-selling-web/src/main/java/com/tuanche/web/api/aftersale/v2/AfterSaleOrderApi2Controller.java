...
@RestController
@RequestMapping("/api/v2/after/sale/order")
public class AfterSaleOrderApi2Controller {
    ...
    public TcResponse submit(HttpServletRequest request, AfterSaleOrderRecordDto afterSaleOrderRecord, String returnUrl) {
        ...
        try {
            ...
            if (afterSaleOrderRecord.getOrderType().equals(AfterSaleConstants.OrderType.PROMOTION_CARD.getCode())) {
                ...
                if (orderRecord!=null) {
                    TcResponse tcResponse = unpaidSubmitOrder(orderRecord.getOrderCode(), orderRecord.getUserWxOpenId(), returnUrl);
