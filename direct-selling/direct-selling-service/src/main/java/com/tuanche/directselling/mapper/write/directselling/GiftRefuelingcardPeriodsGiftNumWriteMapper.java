...
/**
 * @author：HuangHao
 * @CreatTime 2020-05-28 14:15
 */
public interface GiftRefuelingcardPeriodsGiftNumWriteMapper {
     ...
     * 批量新增
     * @author HuangHao
     * @CreatTime 2020-05-28 14:17
     * @param list
     * @return int
     */
    int batchInsert(@Param("list") List<GiftRefuelingcardPeriodsGiftNum> list);
}
